...
组件级消融之所以能做，是因为我们使用的三个基础模型（Toto2、Chronos2、TimesFM）都是 Transformer 架构。Transformer 最初由 Vaswani et al. (2017) 在 "Attention Is All You Need" 中提出，它有一个**明确且固定的积木结构**——不是我们自己拍脑袋分类的，而是论文里画得清清楚楚的架构图。
